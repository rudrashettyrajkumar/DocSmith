...
the client polls GET /api/jobs/{id}. API keys are used to build the chat model
and are never stored on the job or written to logs.
"""
...
class Job:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "events": self.events, "result": self.result, "error": self.error,
